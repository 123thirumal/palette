...
class Free8x8 extends StatefulWidget {
  Free8x8({super.key});
  ...
  @override
  State<Free8x8> createState() => _Free8x8State();
}

class _Free8x8State extends State<Free8x8> {
  ...
  void horhandleSwipe(double velocity) {
    if (widget.canRoll == 0) {
      if (velocity > 0) {
        ...
        for (int i = 1;
            (i <= widget.newSteps) && (widget.currentCol + widget.newSteps < 8);
            i++) {
          if (boxcolor[widget.currentRow][widget.currentCol + i] ==
        ...
        } else if (widget.currentCol + widget.newSteps < 8) {
          setState(() {
        ...
        for (int i = 1;
            (i <= widget.newSteps) &&
                (widget.currentCol - widget.newSteps >= 0);
            i++) {
          if (boxcolor[widget.currentRow][widget.currentCol - i] ==
              const Color(0xFF1B7499)) {
            setState(() {
  ...
  void verhandleSwipe(double velocity) {
    if (widget.canRoll == 0) {
      if (velocity > 0) {
        ...
        for (int i = 1;
            (i <= widget.newSteps) && (widget.currentRow + widget.newSteps < 8);
            i++) {
          if (boxcolor[widget.currentRow + i][widget.currentCol] ==
              const Color(0xFF1B7499)) {
            setState(() {
              widget.swipecheck = 1;
            });
        ...
        } else if (widget.currentRow + widget.newSteps < 8) {
          setState(() {
            //for changing position
        ...
        for (int i = 1;
            (i <= widget.newSteps) &&
                (widget.currentRow - widget.newSteps >= 0);
            i++) {
          if (boxcolor[widget.currentRow - i][widget.currentCol] ==
              const Color(0xFF1B7499)) {
            setState(() {

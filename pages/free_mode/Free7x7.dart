...
class Free7x7 extends StatefulWidget {
  Free7x7({super.key});
  ...
  @override
  State<Free7x7> createState() => _Free7x7State();
}

class _Free7x7State extends State<Free7x7> {
  ...
  void horhandleSwipe(double velocity) {
    if (widget.canRoll == 0) {
      if (velocity > 0) {
        ...
        for(int i=1;(i<=widget.newSteps)&&(widget.currentCol + widget.newSteps < 7);i++){
        ...
        } else if (widget.currentCol + widget.newSteps < 7) {
          setState(() {
  ...
  void verhandleSwipe(double velocity) {
    if (widget.canRoll == 0) {
      if (velocity > 0) {
        ...
        for(int i=1;(i<=widget.newSteps)&&(widget.currentRow + widget.newSteps < 7);i++){
        ...
        } else if (widget.currentRow + widget.newSteps < 7) {
          setState(() {
            //for changing position

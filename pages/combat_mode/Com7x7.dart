...
class Com7x7 extends StatefulWidget {
  Com7x7({super.key});
  ...
  @override
  State<Com7x7> createState() => _Com7x7State();
}

class _Com7x7State extends State<Com7x7> {
  ...
  void _initializeBoard() {
    ...
    List.generate(7, (index) => List.generate(7, (index) => null));

    // Set the center position to an Image asset
    newboard[6][0] = Image.asset('assets/coins/playercoin.png');
    newboard[0][6]=Image.asset('assets/coins/playercoin2.png');

    // Update the board
    setState(() {
      board = newboard;
      widget.currentRow1 = 6;
      widget.currentCol1 = 0;
      widget.currentRow2 = 0;
      widget.currentCol2 = 6;
    });
  }
  ...
  void horhandleSwipe(double velocity) {
    if (widget.canRoll == 0) {
      if(widget.turn==1) { //turn of player1
        if (velocity > 0) {
          // Swiping right

          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentCol1 + widget.newSteps < 7); i++) {
            if ((boxcolor[widget.currentRow1][widget.currentCol1 + i] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow1][widget.currentCol1 + i] ==
                const Color(0xFF4A1E06))||((widget.currentRow1==widget.currentRow2)&&((widget.currentCol1 + i) ==widget.currentCol2))) {
              setState(() {
                widget.swipecheck = 1;
              });
            }
          ...
          } else if (widget.currentCol1 + widget.newSteps < 7) {
            setState(() {
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentCol1 - widget.newSteps >= 0); i++) {
            if ((boxcolor[widget.currentRow1][widget.currentCol1 - i] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow1][widget.currentCol1 - i] ==
                const Color(0xFF4A1E06))||((widget.currentRow1==widget.currentRow2)&&((widget.currentCol1 - i) ==widget.currentCol2))) {
              setState(() {
      ...
      else if(widget.turn==2){ //turn of player2
        if (velocity > 0) {
          // Swiping right

          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentCol2 + widget.newSteps < 7); i++) {
            if ((boxcolor[widget.currentRow2][widget.currentCol2 + i] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow2][widget.currentCol2 + i] ==
                const Color(0xFF4A1E06))||((widget.currentRow2==widget.currentRow1)&&((widget.currentCol2 + i) ==widget.currentCol1))) {
              setState(() {
                widget.swipecheck = 1;
              });
            }
          ...
          } else if (widget.currentCol2 + widget.newSteps < 7) {
            setState(() {
              //for shifting position
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentCol2 - widget.newSteps >= 0); i++) {
            if ((boxcolor[widget.currentRow2][widget.currentCol2 - i] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow2][widget.currentCol2 - i] ==
                const Color(0xFF4A1E06))||((widget.currentRow2==widget.currentRow1)&&((widget.currentCol2 - i) ==widget.currentCol1))) {
              setState(() {
  ...
  void verhandleSwipe(double velocity) {
    if (widget.canRoll == 0) {
      if(widget.turn==1) { //turn for player1
        if (velocity > 0) {
          // Swiping up

          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentRow1 + widget.newSteps < 7); i++) {
            if ((boxcolor[widget.currentRow1+i][widget.currentCol1] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow1+i][widget.currentCol1] ==
                const Color(0xFF4A1E06))||(((widget.currentRow1+i)==widget.currentRow2)&&(widget.currentCol1 ==widget.currentCol2))) {
              setState(() {
                widget.swipecheck = 1;
              });
            }
          ...
          } else if (widget.currentRow1 + widget.newSteps < 7) {
            setState(() {
              //for changing position
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentRow1 - widget.newSteps >= 0); i++) {
            if ((boxcolor[widget.currentRow1-i][widget.currentCol1] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow1-i][widget.currentCol1] ==
                const Color(0xFF4A1E06))||(((widget.currentRow1-i)==widget.currentRow2)&&(widget.currentCol1 ==widget.currentCol2))) {
              setState(() {
      ...
      else if(widget.turn==2){ //turn for player2

        if (velocity > 0) {
          // Swiping up

          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentRow2 + widget.newSteps < 7); i++) {
            if ((boxcolor[widget.currentRow2+i][widget.currentCol2] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow2+i][widget.currentCol2] ==
                const Color(0xFF4A1E06))||(((widget.currentRow2+i)==widget.currentRow1)&&(widget.currentCol2 ==widget.currentCol1))) {
              setState(() {
                widget.swipecheck = 1;
              });
            }
          ...
          } else if (widget.currentRow2 + widget.newSteps < 7) {
            setState(() {
              //for changing position
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentRow2 - widget.newSteps >= 0); i++) {
            if ((boxcolor[widget.currentRow2-i][widget.currentCol2] ==
                const Color(0xFF1B7499))||(boxcolor[widget.currentRow2-i][widget.currentCol2] ==
                const Color(0xFF4A1E06))||(((widget.currentRow2-i)==widget.currentRow1)&&(widget.currentCol2 ==widget.currentCol1))) {
              setState(() {

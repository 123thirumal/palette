...
class Com8x8 extends StatefulWidget {
  Com8x8({super.key});
  ...
  @override
  State<Com8x8> createState() => _Com8x8State();
}

class _Com8x8State extends State<Com8x8> {
  ...
  void _initializeBoard() {
    ...
    newboard[7][0] = Image.asset('assets/coins/playercoin.png');
    newboard[0][7]=Image.asset('assets/coins/playercoin2.png');

    // Update the board
    setState(() {
      board = newboard;
      widget.currentRow1 = 7;
      widget.currentCol1 = 0;
      widget.currentRow2 = 0;
      widget.currentCol2 = 7;
    });
  }
      ...
      if(widget.turn==1) { //turn of player1
        if (velocity > 0) {
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentCol1 + widget.newSteps < 8); i++) {
          ...
          } else if (widget.currentCol1 + widget.newSteps < 8) {
            setState(() {
        ...
        if (velocity > 0) {
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentCol2 + widget.newSteps < 8); i++) {
          ...
          } else if (widget.currentCol2 + widget.newSteps < 8) {
            setState(() {
              //for shifting position
    ...
    if (widget.canRoll == 0) {
      if(widget.turn==1) { //turn for player1
        if (velocity > 0) {
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentRow1 + widget.newSteps < 8); i++) {
          ...
          } else if (widget.currentRow1 + widget.newSteps < 8) {
            setState(() {
              //for changing position
        ...
        if (velocity > 0) {
          ...
          for (int i = 1; (i <= widget.newSteps) &&
              (widget.currentRow2 + widget.newSteps < 8); i++) {
          ...
          } else if (widget.currentRow2 + widget.newSteps < 8) {
            setState(() {
              //for changing position
